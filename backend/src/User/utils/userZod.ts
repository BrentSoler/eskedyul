...
export const SRegister = z.object({
  ...
  mname: z.union([z.string().length(0), z.string().min(2,{ message: "Middle name needs to be atleast 2 letters" }), z.regex(/^[A-Za-z]+$/, { message: "Middle name should only consist of letters" })])
    .optional()
