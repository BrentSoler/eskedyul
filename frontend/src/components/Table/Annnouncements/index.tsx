                        ...
                        {isSuccess && handleFilteredData !== "No Data" ? (
                            currentItems.map((announcement: any) => (
                                <tr key={announcement.id}>
                                    ...
                                    {role === "Master Admin" && (
                                        <td>
                                            <a id = {announcement.id} href="#confirmModal" className="btn-primary mt-10 rounded-lg py-2 px-3 w-max" type="submit">
												Delete  
											</a>
												<div className="modal" id="confirmModal">
													<div className="modal-box">
														...
														<div className="modal-action">
															...
															<button className="btn-primary mt-10 rounded-lg py-2 px-3 w-max" type="submit" onClick={() => controller.deleteAnnouncement(announcement.id)}>
																Confirm
															</button>
														</div>
													</div>
