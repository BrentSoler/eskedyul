	...
	return (
		<div className="flex flex-col items-start justify-center text-lg gap-4">
			<Link href="/dashboard/landing">
				<a
					className={`${router.pathname === "/dashboard/landing" ? "font-bold" : "font-light"
						} transition all`}
				>
					<svg
			...
			<Link href="/dashboard">
				<a
					className={`${router.pathname === "/dashboard" ? "font-bold" : "font-light"
						} transition all`}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<Link href="/dashboard/users">
				<a
					className={`${router.pathname.includes("/dashboard/users") ? "font-bold" : "font-light"
						} transition all`}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<Link href="/dashboard/programs">
				<a
					className={`${router.pathname.includes("/dashboard/programs") ? "font-bold" : "font-light"
						} transition all`}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<Link href="/dashboard/transactions">
				<a
					className={`${router.pathname.includes("/dashboard/transactions") ? "font-bold" : "font-light"
						} transition all`}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
